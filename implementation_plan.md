...
- [x] **9.0** Подготовка инфраструктуры — Obsidian Vault, шаблоны, плагины (ручная)
- [x] **9.1** Syncthing — синхронизация VPS ↔ ноутбук (ручная)
- [x] **9.2** Telegram → Obsidian — writer-модуль, экспорт данных в .md
- [x] **9.3** Obsidian → Telegram — watcher + парсер задач + напоминания
- [x] **9.4** Двусторонняя синхронизация задач
- [x] **9.5** RAG-интеграция с Obsidian-заметками
