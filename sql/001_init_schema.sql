...
INSERT INTO model_routing (task_type, model, max_tokens, temperature, fallback_model) VALUES
    ('meal_photo',       'gpt-4o-mini',             500,  0.3, 'gpt-4o-mini'),
    ('workout_parse',    'gpt-4o-mini',             500,  0.3, NULL),
    ('diary_reflection', 'deepseek/deepseek-v3.2', 1500,  0.7, 'gpt-4o-mini'),
    ('financial_parse',  'gpt-4o-mini',             300,  0.1, NULL),
    ('transcription',    'whisper-1',              NULL, NULL, NULL),
    ('rag_answer',       'gpt-4o-mini',            1000,  0.5, 'gpt-4o-mini'),
    ('vision_ocr',       'gpt-4o-mini',             500,  0.3, 'gpt-4o-mini'),
    ('general_chat',     'gpt-4o-mini',            1000,  0.7, NULL),
    ('receipt_ocr',      'gpt-4o-mini',             800,  0.2, 'gpt-4o-mini'),
    ('order_ocr',        'gpt-4o-mini',             800,  0.2, 'gpt-4o-mini'),
    ('part_photo',       'gpt-4o-mini',             500,  0.3, 'gpt-4o-mini'),
    ('mileage_reminder', 'gpt-4o-mini',             800,  0.5, NULL),
    ('daily_summary',    'gpt-4o-mini',             800,  0.5, NULL),
    ('mentor_idea',      'deepseek/deepseek-v3.2', 1500,  0.7, 'gpt-4o-mini'),
    ('mentor_discussion','deepseek/deepseek-v3.2', 3000,  0.5, 'gpt-4o-mini'),
    ('mentor_strategy',  'deepseek/deepseek-v3.2', 2000,  0.6, 'gpt-4o-mini'),
    ('mentor_report',    'deepseek/deepseek-v3.2', 2500,  0.5, 'gpt-4o-mini'),
    ('family_parse',     'gpt-4o-mini',             500,  0.2, NULL),
    ('family_receipt',   'gpt-4o-mini',             500,  0.3, 'gpt-4o-mini'),
    ('family_report',    'gpt-4o-mini',             800,  0.5, NULL),
    ('psychology_diary', 'deepseek/deepseek-v3.2', 2000,  0.5, 'gpt-4o-mini'),
    ('psychology_habit', 'gpt-4o-mini',             300,  0.6, NULL),
    ('master_audit',     'deepseek/deepseek-v3.2', 3000,  0.5, 'gpt-4o-mini'),
    ('master_talk',      'deepseek/deepseek-v3.2', 1000,  0.7, 'gpt-4o-mini'),
    ('master_goal',      'deepseek/deepseek-v3.2',  500,  0.2, 'gpt-4o-mini');
