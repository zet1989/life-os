...
INSERT INTO model_routing (task_type, model, max_tokens, temperature, fallback_model) VALUES
    ('meal_photo',       'gpt-4o-mini',        500,  0.3, 'gpt-4o'),
    ('workout_parse',    'gpt-4o-mini',        500,  0.3, NULL),
    ('diary_reflection', 'claude-3.5-sonnet', 1500,  0.7, 'gpt-4o'),
    ('financial_parse',  'gpt-4o-mini',        300,  0.1, NULL),
    ('transcription',    'whisper-1',         NULL, NULL, NULL),
    ('rag_answer',       'gpt-4o-mini',       1000,  0.5, 'gpt-4o'),
    ('vision_ocr',       'gpt-4o-mini',        500,  0.3, 'gpt-4o'),
    ('general_chat',     'gpt-4o-mini',       1000,  0.7, NULL),
    ('receipt_ocr',      'gpt-4o',             800,  0.2, 'gpt-4o-mini'),
    ('order_ocr',        'gpt-4o',             800,  0.2, 'gpt-4o-mini'),
    ('part_photo',       'gpt-4o-mini',        500,  0.3, 'gpt-4o'),
    ('mileage_reminder', 'gpt-4o-mini',        800,  0.5, NULL),
    ('daily_summary',    'gpt-4o-mini',        800,  0.5, NULL),
    ('mentor_idea',      'claude-3.5-sonnet', 1500,  0.7, 'gpt-4o'),
    ('mentor_discussion','claude-3.5-sonnet', 3000,  0.5, 'gpt-4o'),
    ('mentor_strategy',  'claude-3.5-sonnet', 2000,  0.6, 'gpt-4o'),
    ('mentor_report',    'claude-3.5-sonnet', 2500,  0.5, 'gpt-4o'),
    ('family_parse',     'gpt-4o-mini',        500,  0.2, NULL),
    ('family_receipt',   'gpt-4o-mini',        500,  0.3, 'gpt-4o'),
    ('family_report',    'gpt-4o-mini',        800,  0.5, NULL),
    ('psychology_diary', 'gpt-4o-mini',        800,  0.7, NULL),
    ('psychology_habit', 'gpt-4o-mini',        300,  0.6, NULL),
    ('master_audit',     'claude-3.5-sonnet', 3000,  0.5, 'gpt-4o'),
    ('master_talk',      'gpt-4o-mini',       1000,  0.7, 'claude-3.5-sonnet'),
    ('master_goal',      'gpt-4o-mini',        500,  0.2, NULL);
